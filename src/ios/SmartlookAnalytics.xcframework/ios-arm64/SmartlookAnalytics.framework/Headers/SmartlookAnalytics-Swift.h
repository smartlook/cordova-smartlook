...
SWIFT_CLASS_NAMED("BridgeInterface")
@interface SLBridgeInterface : NSObject
...
/// When this property has nonull value, the <code>obtainFrameworkInfo(completion:)</code> is <em>not</em> called.
...
///
- (void)obtainWireframeDataWithCompletion:(void (^ _Nonnull)(SLWireframeData * _Nullable))completion;
...
/// Returns an empty wireframe data model object.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIColor;

/// An object represents one item in the wireframe model.
/// This object is designed only for internal use in SDK.
SWIFT_CLASS_NAMED("WireframeDataItem")
@interface SLWireframeDataItem : NSObject
/// The left position (x-coordinate) of a rectangle.
@property (nonatomic) double left;
/// The top position (y-coordinate) of a rectangle.
@property (nonatomic) double top;
/// The width of a rectangle.
@property (nonatomic) double width;
/// The height of a rectangle.
@property (nonatomic) double height;
/// The wireframe item’s color.
@property (nonatomic, strong) UIColor * _Nullable color;
/// Returns a wireframe data item object initialized to default empty state.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
