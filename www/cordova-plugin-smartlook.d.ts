...
export declare function trackSelector(
	options: {
		selectorName: string;
		props?: Record<string, string>;
	},
...
export declare function trackNavigationEnter(
	options: {
		eventName: string;
		props?: Record<string, string>;
	},
...
export declare function trackNavigationExit(
	options: {
		eventName: string;
		props?: Record<string, string>;
	},
...
export declare function setReferrer(
	options: {
		referrer: string;
		source: string;
	},
...
export declare function putGlobalEventProperty(
	options: {
		propertyName: string;
		value: string;
	},
...
export declare function getGlobalEventProperty(
	options: {
		propertyName: string;
	},
	successCallback: SuccessCallback<string>,
...
export declare function removeGlobalEventProperty(
	options: {
		propertyName: string;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function clearGlobalEventProperties(
	successCallback: SuccessCallback<boolean>,
	errorCallback: ErrorCallback,
): void;
export declare function setUserIdentifier(
	options: {
		identifier: string;
	},
	successCallback?: SuccessCallback<boolean>,
...
export declare function setUserName(
	options: {
		name: string;
	},
	successCallback?: SuccessCallback<boolean>,
...
export declare function setUserProperty(
	options: {
		propertyName: string;
		value: string;
	},
...
export declare function getUserProperty(
	options: {
		propertyName: string;
	},
	successCallback: SuccessCallback<string>,
...
export declare function removeUserProperty(
	options: {
		propertyName: string;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function getSessionUrlWithTimestamp(
	successCallback: SuccessCallback<string>,
	errorCallback?: ErrorCallback,
): void;
export declare function setRelayProxyHost(
	options: {
...
export declare function setFrameRate(
	options: {
		frameRate: number;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function setJobUploadEnabled(
	options: {
		isEnabled: boolean;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function setAdaptiveFrameRateEnabled(
	options: {
		isEnabled: boolean;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function getAdaptiveFrameRateEnabled(
	successCallback: SuccessCallback<boolean>,
	errorCallback?: ErrorCallback,
): void;
export declare function setSurfaceCaptureEnabled(
	options: {
		isEnabled: boolean;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function getSurfaceCaptureEnabled(
	successCallback: SuccessCallback<boolean>,
	errorCallback?: ErrorCallback,
): void;
export declare function eventTrackingEnableAll(
	successCallback?: SuccessCallback<string>,
	errorCallback?: ErrorCallback,
): void;
export declare function eventTrackingDisableAll(
	successCallback?: SuccessCallback<string>,
	errorCallback?: ErrorCallback,
): void;
export declare function setProjectKey(
	options: {
		key: string;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function setEventTrackingInteractionUserStatus(
	options: {
		isEnabled: boolean;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function setEventTrackingInteractionRageClickStatus(
	options: {
		isEnabled: boolean;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function setWebViewSensitivity(
	options: {
		isSensitive: boolean;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function getRenderingMode(
	successCallback: SuccessCallback<RenderingMode>,
	errorCallback?: ErrorCallback,
): void;
...
export declare function getStateFrameRate(
	successCallback: SuccessCallback<number>,
	errorCallback?: ErrorCallback,
): void;
export declare function setRenderingMode(
	options: {
		renderingMode: RenderingMode;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function registerUserUrlChangedListener(
	options: {
		userUrlChangedCallback: (userUrl: string) => void;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function registerSessionUrlChangedListener(
	options: {
		sessionUrlChangedCallback: (sessionUrl: string) => void;
	},
	successCallback?: SuccessCallback<string>,
...
export declare function registerRenderingModeChangedListener(
	options: {
		renderingModeChangedCallback: (renderingMode: string) => void;
	},
	successCallback?: SuccessCallback<string>,
	errorCallback?: ErrorCallback,
): void;
export declare function registerRecordingStatusChangedListener(
	options: {
		recordingStatusChangedCallback: (recordingStatus: string) => void;
	},
	successCallback?: SuccessCallback<string>,
	errorCallback?: ErrorCallback,
): void;
export declare function removeUserUrlChangedListener(
	successCallback?: SuccessCallback<boolean>,
	errorCallback?: ErrorCallback,
): void;
export declare function removeSessionUrlChangedListener(
	successCallback?: SuccessCallback<boolean>,
	errorCallback?: ErrorCallback,
): void;
export declare function removeRenderingModeChangedListener(
	successCallback?: SuccessCallback<boolean>,
	errorCallback?: ErrorCallback,
): void;
export declare function removeRecordingStatusChangedListener(
	successCallback?: SuccessCallback<boolean>,
	errorCallback?: ErrorCallback,
): void;
export declare function setRecordingMask(
	options: {
		recordingMaskList: Array<{
			maskType: RecordingMaskType;
			maskRect: {
